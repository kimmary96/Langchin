...
| **상황적 위로** | 증상 때문에 오늘 하루 일상이 얼마나 고단할지 헤아려 위로 |
...
- 사용자가 병원 요청 시 **네이버 지도 링크 버튼** 자동 삽입
...
- 사용자가 언급하지 않은 증상을 임의로 지어내지 않음
- 의학적 진단을 내리거나 특정 진료과를 직접 명시하지 않음
- 번호 매기기, 불릿 포인트 대신 대화하듯 자연스럽게 풀어냄
